...
그 말인 즉슨, ALT + TAB 키를 눌러 인터넷 창을 띄워 검색한다던지, 스마트폰이나 또다른 PC를 사용하여 문제를 검색해 볼 수 있다는 것입니다. 혹시나 리눅스마스터 2급 1차를 시험 볼 생각이 있으시다면 본 사이트를 즐겨찾기 해 놓으시고, 시험 때 Ctrl + F 키를 눌러 문제 제목이나 명령어를 검색하시면 좋습니다.  
